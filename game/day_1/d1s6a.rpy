label d1s6a:
    ...
    show emily fake_smile with dissolve
...
label d1s6ao2:
    show emily angry
    show ron sympathetic
    show norman angry 
    with dissolve

    r "Maybe go easy on him, Mayor Sawyer—that's kinda intense."

    show emily serious with dissolve
    show norman smug with dissolve
...
label d1s6ac1:
    ...
    show emily smile at dialogright 
    with move
    ...
    show emily worried with dissolve
...
label d1s6ac2:
    ...
    show marley thoughtful at dialogright with dissolve
    show danny neutral at dialogleft with dissolve
...
label after_rune_making_minigame:
    ...
    show marley curious at center
    show danny neutral at left
    with move

    show norman moody at offscreenright
    ...
    show marley confused at dialogleft
    show norman angry at dialogright
    with move
...
label d1s6ac3:
    ...
    show emily neutral at dialogright with dissolve
...
label after_search_office_minigame:
    ...
    show ron neutral at dialogright
    show marley neutral at dialogleft
    with move
