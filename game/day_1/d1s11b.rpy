# Mrs. Pear or Emily?
label d1s11b:
    show pear worried at right with dissolve
    ...
    show pear serious at left with dissolve
...
label d1s11b_emily:
    show pear neutral at right with dissolve
    show emily neutral at center with dissolve
    show marley neutral at left with dissolve
    show ron neutral at left with dissolve
    ...
    show emily smile at right with move
    ...
    show emily awkward at right with dissolve
...
label d1s11b_emily_o1:
    ...
    show emily thoughtful at right with dissolve
...
label d1s11b_emily_c2o2:
    ...
    show emily laughing at right with dissolve
...
label d1s11b_pear:
    ...
    show pear smile at right with dissolve
    ...
    show pear thoughtful at right with dissolve
...
label d1s11b_pear_o2:
    ...
    show pear moody at right with dissolve
    ...
    show pear awkward at right with dissolve

    l "I... I don't wanna say."

    show ron confused at right with dissolve
    ...
    show pear serious at right with dissolve
