...
label d1s11c_norman_o1:
    ...
    show norman smile at right with dissolve
...
label d1s11c_norman_o2:
    ...
    show norman awkward at right with dissolve
...
label d1s11c_norman_o3:
    ...
    show marley disgusted at left with dissolve
    ...
    show norman worried at right with dissolve
    ...
    show marley scared at left with dissolve
...
label d1s11c_norman_c2o2:
    ...
    show norman curious at right with dissolve
...
label d1s11c_norman_c2o5:
    ...
    show norman surprised at right with dissolve
