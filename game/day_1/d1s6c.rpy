...
label d1s6c:
    ...
    show danny at right
    show ron at centerright
    show marley at centerleft
    with move

    show terry smile at left with move

    t "Ron, you old dog, is that you?"

    "Oh crap oh crap oh crap oh crap oh crap."

    show ron fake_smile with dissolve
...
label d1s6co2:
    ...
    show ron forced_smile with dissolve
