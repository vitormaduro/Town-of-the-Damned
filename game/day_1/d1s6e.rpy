...
label d1s6e:
    ...
    show marley at centerright
    show ron at centerleft
    with move

    show pear neutral at offscreenleft
    show pear neutral at left with move

    r "Holy cow, it's Mrs. Pear! I thought she'd be long dead!"

    show pear angry with dissolve
    ...
    show pear neutral with dissolve
    ...
    "Uh oh. Seems like Mrs. Pear is catching onto the truth. She always was sharp as a whip."

    show pear moody with dissolve
    ...
    show ron laughing with dissolve
...
label d1s6eo1:
    show danny neutral at right with dissolve
    show marley angry at centerright with dissolve
    show ron angry at centerleft with dissolve
    ...
    show pear awkward with dissolve
...
label d1s6eo2:
    ...
    show marley angry at centerright with dissolve
    show ron serious at centerleft with dissolve
    show pear moody at left with dissolve
    ...
    show pear thoughtful with dissolve
...
label d1s6ec1:
    show danny neutral at right with dissolve
    show marley neutral at centerright with dissolve
    ...
    show pear nervous with dissolve
    ...
    show danny uncertain with dissolve
    show pear neutral with dissolve
    ...
    show ron neutral at dialogleft
    show marley neutral at dialogright 
    with move
    ...
    show seb nervous at dialogright with dissolve
    show ron nervous at dialogleft with dissolve
    ...
    show seb laughing with dissolve
    ...
    show ron neutral at left
    show seb neutral at right
    with move

    show danny neutral at offscreenleft
    show danny neutral at center with move
    ...
    show ron neutral at dialogleft 
    show danny moody at dialogright
    with move
    ...
    show ron angry at center 
    show danny moody at right
    with move
